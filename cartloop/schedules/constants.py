...
"""
Max number of messaged that could be sent in an hour
"""
MAX_MESSAGES_IN_AN_HOUR = 90

"""
Min and MAx time range for supported hours
"""
TIME_RANGE = [
...
TIMEZONES = ['Africa/Abidjan', 'Africa/Accra', 'Africa/Addis_Ababa', 'Africa/Algiers', 'Africa/Asmara', 'Africa/Asmera',
             ...
             'Europe/Zaporozhye', 'Europe/Zurich', 'GB', 'GB-Eire', 'GMT', 'GMT+0', 'GMT-0', 'GMT0', 'Greenwich', 'HST',
             ...
             'US/Indiana-Starke', 'US/Michigan', 'US/Mountain', 'US/Pacific', 'US/Samoa', 'UTC', 'Universal', 'W-SU',
             'WET', 'Zulu']
